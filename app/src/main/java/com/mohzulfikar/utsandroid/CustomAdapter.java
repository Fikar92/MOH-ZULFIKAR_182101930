...
public class CustomAdapter extends RecyclerView.Adapter<com.mohzulfikar.utsandroid.CustomAdapter.CustomViewHolder> {
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        final com.mohzulfikar.utsandroid.CustomAdapter mAdapter;

        public CustomViewHolder(View itemView, com.mohzulfikar.utsandroid.CustomAdapter adapter){
            super(itemView)     ;
